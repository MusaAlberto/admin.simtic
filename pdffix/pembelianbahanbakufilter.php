<?php
	...
	$query = mysqli_query($conn,"SELECT * FROM `apl_pembelian` WHERE Month(apl_pembelian.Tanggal_Beli)='$angka' AND YEAR(apl_pembelian.Tanggal_Beli)='$tahun'");
	...
	$query2 = "SELECT sum(Total_Pembelian) as jumlah FROM `apl_pembelian` WHERE Month(apl_pembelian.Tanggal_Beli)='$angka' AND YEAR(apl_pembelian.Tanggal_Beli)='$tahun'";
	...
	$pdf->Output("pembelianfilter.pdf","D");
