<?php
	$title = 'DATA GAJI YANG BELUM DIAMBIL';
	require('fpdf.php');
	...
	class PDF extends FPDF{
		...
		function Header(){
			...
			$this->Cell(30,5,'BULAN',1,0,'',true);
			$this->Cell(25,5,'TAHUN',1,0,'',true);
	...
	while($data=mysqli_fetch_array($query)){
		...
		$pdf->Cell(30,5,$data['bulan'],1,0);
		$pdf->Cell(25,5,$data['tahun'],1,0);
	...
	$query2 = "SELECT sum(Total_Gaji) as jumlah FROM `apl_penggajian` WHERE apl_penggajian.Status_Pengambilan=0 ";
