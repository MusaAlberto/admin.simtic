	...
	<script>
		$(document).ready(function(){
			var tabel = $('#tabel-data').dataTable({
				...
				"bAutoWidth": 	true,
				"bSort": 		false,
				"sAjaxSource": 	'<?php echo base_url(); ?>tentor/data',
				"aoColumns":	[
									{ "mData"	: "no"},
									{ "mData"	: "nama"},
									{ "mData"	: "alamat"},
			...
			$('#btn-tambah').click(function(){
				$('#form-tambah').attr('action','<?=base_url()?>tentor/tambah');
			...
			$('#tabel-body').on('click', '#btn-ubah', function(){
				...
				$('#form-tambah').attr('action','<?=base_url()?>tentor/edit');
				$('#id').val($(this).data('id'));
