  ...
  <script>
    $(document).ready(function(){
      var tabel = $('#tabel-data').dataTable({
        ...
        "bAutoWidth":   true,
        "bSort":    false,
        "sAjaxSource":  '<?php echo base_url(); ?>simulasi_listening/data',
        "aoColumns":  [
                  { "mData" : "no"},
                  { "mData" : "kode"},
                  { "mData" : "audio"},
      ...
      $('#btn-tambah').click(function(){
        ...
        $('#form-tambah').attr('action','<?=base_url()?>simulasi_listening/tambah');
      ...
      $('#simpan').click(function() {
        ...
        $.ajax({
        url: '<?php echo base_url() ?>simulasi_listening/tambah',
        type: 'post',
        dataType: 'json',
        data: data,
        async: false,
      ...
      $('#tabel-body').on('click', '#btn-ubah', function(){
          ...
          $('#form-edit').attr('action','<?=base_url()?>simulasi_listening/edit');
      ...
      $('#edit').click(function() {
        ...
        $.ajax({
        url: '<?php echo base_url() ?>simulasi_listening/edit',
        type: 'post',
        dataType: 'json',
        data: data,
        async: false,
        ...
        function(isConfirm){
          if (isConfirm) {
            $.ajax({
              type:     'ajax',
              method:   'post',
              url:    '<?=base_url()?>'+'simulasi_listening/hapus/' + id,
              async:    true,
              dataType:   'json',
