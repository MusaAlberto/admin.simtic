            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>
                  ...
                  <a href="<?=base_url()?>ujian_reading">
                    Data Soal Tes Reading
                  </a>
                </h2>
  ...
  <script>
    $(document).ready(function(){
      var tabel = $('#tabel-data').dataTable({
        ...
        "bAutoWidth":   true,
        "bSort":    false,
        "sAjaxSource":  '<?php echo base_url(); ?>ujian_reading/data',
        "aoColumns":  [
                  { "mData" : "no"},
                  { "mData" : "kode"},
                  { "mData" : "gambar"},
      ...
      $('#btn-tambah').click(function(){
        $('#form-tambah').attr('action','<?=base_url()?>ujian_reading/tambah');
      ...
      $('#tabel-body').on('click', '#btn-ubah', function(){
        ...
        $('#form-tambah').attr('action','<?=base_url()?>ujian_reading/edit');
        $('#id').val($(this).data('id'));
        ...
        function(isConfirm){
          if (isConfirm) {
            $.ajax({
              type:     'ajax',
              method:   'post',
              url:      '<?=base_url()?>'+'ujian_reading/hapus/' + id,
              async:    true,
              dataType: 'json',
              success:  function(response){
                if(response==true){
